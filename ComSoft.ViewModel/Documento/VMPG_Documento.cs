...
namespace ComSoft.ViewModel.Documento
{
    ...
    public class VMPG_Documento : CHNavigationService, CHINavigation
    {
        ...
        private CHObservableCollection<EComSoft_Documento> _Collection_DatoDocumento;
        public CHObservableCollection<EComSoft_Documento> Collection_DatoDocumento
        {
            get
            {
                if (_Collection_DatoDocumento == null)
                    _Collection_DatoDocumento = new CHObservableCollection<EComSoft_Documento>();
                return _Collection_DatoDocumento;
            }
        }
        ...
        public ICommand INuevo
        {
            get
            {
                ...
                {
                    CHModalDialog.GetContent().ShowDialog(CHPage.GetPage("VMP_Documento"), new EComSoft_Documento() { Opcion = "I" });
                    Method_CargaDatos();
                });
            }
        }
